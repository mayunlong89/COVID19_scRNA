...
warnings.filterwarnings("ignore")
data=sc.read_loom('/share/pub/qiuf/COVID/01-data/CELL/recluster_file/pbmc.loom', sparse=True)
...
plt.savefig('/share/pub/qiuf/COVID/ann/Hashimoto_proportion1.pdf')
#plt.savefig('/share/pub/qiuf/COVID/01-data/CELL/recluster_file/loom/Hashimoto_proportion1.pdf')
...
print(sim_results.credible_effects())
import pickle as pkl
path = "/share/pub/qiuf/COVID/01-data/CELL/recluster_file/loom/MildS"
sim_results.save(path)
...
print(sim_results.credible_effects())
import pickle as pkl
path = "/share/pub/qiuf/COVID/01-data/CELL/recluster_file/loom/ModeS"
sim_results.save(path)
